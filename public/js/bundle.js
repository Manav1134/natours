...
},{}],"loigin.js":[function(require,module,exports) {
"use strict";
...
if (loginForm) loginForm.addEventListener("submit", function (e) {
  e.preventDefault();
  var email = document.getElementById("email").value; //we use value propert in order to read value
  var password = document.getElementById("password").value;
  (0, _loigin.login)(email, password);
});
if (logOutBtn) logOutBtn.addEventListener("click", _loigin.logout);
if (userDataForm) {
